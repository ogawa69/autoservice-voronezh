...
import type { AnimatedContentContainer, AnimatedContentProps } from "./types";

gsap.registerPlugin(ScrollTrigger);

function resolveScroller(container?: AnimatedContentContainer) {
  const candidate =
...
export default function AnimatedContent({
  ...
  useEffect(() => {
    ...
    const scrollerTarget = resolveScroller(container);
