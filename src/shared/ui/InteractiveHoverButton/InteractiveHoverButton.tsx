...
import type { InteractiveHoverButtonProps } from "./types";
...
>({
  ...
  className,
  ...props
}: InteractiveHoverButtonProps<TElement>) {
  ...
  return (
    ...
    >
      <div className="flex items-center justify-center gap-2">
        <div className="interactive-hover-button-fill bg-primary h-2 w-2 rounded-full transition-transform duration-300 group-hover:scale-[100.8]" />
